...
# Input  --> pdf2 - Dataframe containing positive regions information. (Bz concentration value[in Gauss], Coordinates[x,y], Pixel area of the region)
#        --> ndf2 - Dataframe containing negative regions information. (Bz concentration value[in Gauss], Coordinates[x,y], Pixel area of the region)
